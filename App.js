...
// CHILDREN - If we want to access the innerHtml of a react component or its nested components
// we can use this.props.children
class Parent extends React.Component {
  render() {
    return <Button>I <Heart /> Hello Inner HTML</Button>;
  }
}

class Button extends React.Component {
  render() {
   // Using the this.props.children will render the button with the innerHtml given to it
   // from the parent component (Hello Inner HTML) and also the nested Heart stateless component
